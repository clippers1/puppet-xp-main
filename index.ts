...
import entryHandleText from './src/entrance/room-text.js'
import schedule from "node-schedule";
import { getServerStatus } from "./src/service/getStatus.js";
import config from './src/config/index.js'

const sendServerStatusRule = new schedule.RecurrenceRule();
sendServerStatusRule.hour = 7;
